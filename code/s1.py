...
def getInboxFiles():
    ...
    try:
        inboxFiles = os.listdir('/Users/shawn/PycharmProjects/ASSIP2/inbox')
    except FileNotFoundError:
        exit("You do not have an inbox folder!")

def checkOutboxFolder():
    try:
        os.listdir('/Users/shawn/PycharmProjects/ASSIP2/outbox')
    except FileNotFoundError:
...
def getUserConfigurationFile():
    ...
    userCon = open('/Users/shawn/PycharmProjects/ASSIP2/config/user-config.json')
...
def grabAssignmentConfig():
    ...
    assiCon = open('/Users/shawn/PycharmProjects/ASSIP2/config/assignment-config.json',)
...
def grabUserKeys():
    ...
    file = open("/Users/shawn/PycharmProjects/ASSIP2/key/userKeys.txt")
...
def grabSessionKeys():
    ...
    file = open("/Users/shawn/PycharmProjects/ASSIP2/key/sessionKeys.txt")
    lines = file.readlines()
    for line in lines:
        sessions = line.split(" ")
...
def saveSessionKeys():
    ...
    file = open("/Users/shawn/PycharmProjects/ASSIP2/key/sessionKeys.txt", "w+")
...
def generateSessionKeys():
    ...
    sessCon = open('/Users/shawn/PycharmProjects/ASSIP2/config/session-config.json',)
...
def grabSectionKeys(sectionFile):
    ...
    sectionFileForRead = open("/Users/shawn/PycharmProjects/ASSIP2/key/sectionKeys.txt", "r")
...
def anonAssignment(taskName):
    ...
    anonAssiName = str(headName).strip()
...
def anonAllAttempts(inputFile):
    print("Anonymized File Name")
    data = []
...
def main():
    ...
    if os.path.isfile("/Users/shawn/PycharmProjects/ASSIP2/key/sessionKeys.txt"):
        grabSessionKeys()
    else:
        generateSessionKeys()
        saveSessionKeys()

    userFile = open("/Users/shawn/PycharmProjects/ASSIP2/key/userKeys.txt", 'a+')
    if os.path.isfile("/Users/shawn/PycharmProjects/ASSIP2/key/userKeys.txt"):
        grabUserKeys()
    else:
        userDict = {}

    sectionFile = open("/Users/shawn/PycharmProjects/ASSIP2/key/sectionKeys.txt", "a+")  # open and grab keys from the section file
    sectionDict = grabSectionKeys(sectionFile)
    print("Read section keys: ", sectionDict)  # prints the keys

    f = open("/Users/shawn/PycharmProjects/ASSIP2/code/anonymization-results.txt", "w+")  # this is the anonymization-results file, doesn't really matter
